...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     *   rhoh(16),rhos(16)
      common /pass2/ amass(16),Fr(500000,16),rhor(500000,16,16),
     *   rphi(500000,16,16),blat(16),drho,dr,rc,outfile,outelem
...
15      continue
        write(2,*) " "
        do 18 k=1,ntypes
          write(3,*) "# atom,atom ",i,k
          do 19 j=1,nr
            write(3,14) (j-1)*dr,rhor(j,i,k)
19        continue
          write(3,*) " "
18      continue
10    continue
...
c          write(1,12)(z2r(i,i1,i2),i=1,nr)
          ...
          do 20 j=1,nr
            write(4,14) (j-1)*dr,rphi(j,i1,i2)
20        continue
          write(4,*) " "
13    continue

...
def f(x):
  ...
  diffpxx = (float(pxxl) - float(pxxp))/float(pxxp)*100.0/6.0
  diffpyy = (float(pyyl) - float(pyyp))/float(pyyp)*100.0/6.0 
  diffpzz = (float(pzzl) - float(pzzp))/float(pzzp)*100.0/6.0 
  diffpxy = (float(pxyl) - float(pxyp))/float(pxyp)*100.0/6.0 
  diffpxz = (float(pxzl) - float(pxzp))/float(pxzp)*100.0/6.0 
  diffpyz = (float(pyzl) - float(pyzp))/float(pyzp)*100.0/6.0 
  ...
  y = abs(diffea)**2 + 1000*abs(float(rhoin1) - float(rhoin2))**2 + 1000*abs(float(rhoe1) - float(rhoe2))**2 + 1000*abs(float(rhoout1) - float(rhoout2))**2 + 0.0000002*abs(diffp)**2 + 0.0000002*abs(difff)**2

...
print "weight     : ",weig
#----------------------------------------------------------------------
print "read parameters from EAM_code_v2.init"
nline = commands.getoutput("grep -n "+str(satom)+" EAM_code_v2.init | head -1 | sed -e \"s/:.*//g\"")
print "read line: "+nline
check_satom = commands.getoutput("awk '{if(NR=="+str(nline)+"+0){print $1}}' EAM_code_v2.init | head -1")
print "fit element: "+check_satom
# fitting parameters
x0  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+1){print $1}}' EAM_code_v2.init | head -1"))
x1  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+2){print $1}}' EAM_code_v2.init | head -1"))
x2  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+3){print $1}}' EAM_code_v2.init | head -1"))
x3  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+4){print $1}}' EAM_code_v2.init | head -1"))
x4  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+5){print $1}}' EAM_code_v2.init | head -1"))
x5  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+6){print $1}}' EAM_code_v2.init | head -1"))
x6  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+7){print $1}}' EAM_code_v2.init | head -1"))
x7  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+8){print $1}}' EAM_code_v2.init | head -1"))
x8  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+9){print $1}}' EAM_code_v2.init | head -1"))
x9  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+10){print $1}}' EAM_code_v2.init | head -1"))
x10 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+11){print $1}}' EAM_code_v2.init | head -1"))
x11 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+12){print $1}}' EAM_code_v2.init | head -1"))
x12 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+13){print $1}}' EAM_code_v2.init | head -1"))
x13 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+14){print $1}}' EAM_code_v2.init | head -1"))
x14 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+15){print $1}}' EAM_code_v2.init | head -1"))
x15 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+16){print $1}}' EAM_code_v2.init | head -1"))
x16 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+17){print $1}}' EAM_code_v2.init | head -1"))
x17 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+18){print $1}}' EAM_code_v2.init | head -1"))
x18 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+19){print $1}}' EAM_code_v2.init | head -1"))
x19 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+20){print $1}}' EAM_code_v2.init | head -1"))
x20 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+21){print $1}}' EAM_code_v2.init | head -1"))
x21 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+22){print $1}}' EAM_code_v2.init | head -1"))
x22 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+25){print $1}}' EAM_code_v2.init | head -1"))
x23 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+26){print $1}}' EAM_code_v2.init | head -1"))
x24 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+27){print $1}}' EAM_code_v2.init | head -1"))
x25 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+28){print $1}}' EAM_code_v2.init | head -1"))
print "initial parameters: ",x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25
x = [x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25]
print "initial parameters: ",x

count = 0
#----------------------------------------------------------------------
n_gene = 26 # number of parameters
...
def example_fitness( individual ):
  ...
  text = text.replace('k1',str(individual[4]).replace("[","").replace("]",""))
  text = text.replace('k2',str(individual[5]).replace("[","").replace("]",""))
  text = text.replace('k3',str(individual[6]).replace("[","").replace("]",""))
  text = text.replace('k4',str(individual[7]).replace("[","").replace("]",""))
  text = text.replace('k5',str(individual[8]).replace("[","").replace("]",""))
  text = text.replace('k6',str(individual[9]).replace("[","").replace("]",""))
  text = text.replace('k7',str(individual[10]).replace("[","").replace("]",""))
  text = text.replace('k8',str(individual[11]).replace("[","").replace("]",""))
  text = text.replace('Fn0',str(individual[12]).replace("[","").replace("]",""))
  text = text.replace('Fn1',str(individual[13]).replace("[","").replace("]",""))
  text = text.replace('Fn2',str(individual[14]).replace("[","").replace("]",""))
  text = text.replace('Fn3',str(individual[15]).replace("[","").replace("]",""))
  text = text.replace('F0',str(individual[16]).replace("[","").replace("]",""))
  text = text.replace('F1',str(individual[17]).replace("[","").replace("]",""))
  text = text.replace('F2',str(individual[18]).replace("[","").replace("]",""))
  text = text.replace('F3',str(individual[19]).replace("[","").replace("]",""))
  text = text.replace('eta',str(individual[20]).replace("[","").replace("]",""))
  text = text.replace('Fep',str(individual[21]).replace("[","").replace("]",""))
  text = text.replace('F4',str(individual[22]).replace("[","").replace("]",""))
  text = text.replace('p1',str(individual[23]).replace("[","").replace("]",""))
  text = text.replace('hc',str(individual[24]).replace("[","").replace("]",""))
  text = text.replace('rhol',str(individual[25]).replace("[","").replace("]",""))
  fi.close

  with open(file_inp,'w') as f:
    print >> f, text

  commands.getoutput("./Zhou04_EAM_v21 < EAM.input")
  ...
  print "Parameters: x0 = "+"[ "+str(individual[0])+","+str(individual[1])+","+str(individual[2])+","+str(individual[3])+","+str(individual[4])+","+str(individual[5])+","+str(individual[6])+","+str(individual[7])+","+str(individual[8])+","+str(individual[9])+","+str(individual[10])+","+str(individual[11])+","+str(individual[12])+","+str(individual[13])+","+str(individual[14])+","+str(individual[15])+","+str(individual[16])+","+str(individual[17])+","+str(individual[18])+","+str(individual[19])+","+str(individual[20])+","+str(individual[21])+","+str(individual[22])+","+str(individual[23])+","+str(individual[24])+","+str(individual[25])+" ]"
  print "------------------------"

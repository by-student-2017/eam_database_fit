...
x0 = [x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25]
...
def f(x):
  ...
  text = text.replace('k1',str(x[4]).replace("[","").replace("]",""))
  text = text.replace('k2',str(x[5]).replace("[","").replace("]",""))
  text = text.replace('k3',str(x[6]).replace("[","").replace("]",""))
  text = text.replace('k4',str(x[7]).replace("[","").replace("]",""))
  text = text.replace('k5',str(x[8]).replace("[","").replace("]",""))
  text = text.replace('k6',str(x[9]).replace("[","").replace("]",""))
  text = text.replace('k7',str(x[10]).replace("[","").replace("]",""))
  text = text.replace('k8',str(x[11]).replace("[","").replace("]",""))
  text = text.replace('Fn0',str(x[12]).replace("[","").replace("]",""))
  text = text.replace('Fn1',str(x[13]).replace("[","").replace("]",""))
  text = text.replace('Fn2',str(x[14]).replace("[","").replace("]",""))
  text = text.replace('Fn3',str(x[15]).replace("[","").replace("]",""))
  text = text.replace('F0',str(x[16]).replace("[","").replace("]",""))
  text = text.replace('F1',str(x[17]).replace("[","").replace("]",""))
  text = text.replace('F2',str(x[18]).replace("[","").replace("]",""))
  text = text.replace('F3',str(x[19]).replace("[","").replace("]",""))
  text = text.replace('eta',str(x[20]).replace("[","").replace("]",""))
  text = text.replace('Fep',str(x[21]).replace("[","").replace("]",""))
  text = text.replace('F4',str(x[22]).replace("[","").replace("]",""))
  text = text.replace('p1',str(x[23]).replace("[","").replace("]",""))
  text = text.replace('hc',str(x[24]).replace("[","").replace("]",""))
  text = text.replace('rhol',str(x[25]).replace("[","").replace("]",""))
  fi.close
  ...
  print "Evaluate: ", y
  #print "Parameters: ", x
  print "Parameters: x0 = "+"[ "+str(x[0])+","+str(x[1])+","+str(x[2])+","+str(x[3])+","+str(x[4])+","+str(x[5])+","+str(x[6])+","+str(x[7])+","+str(x[8])+","+str(x[9])+","+str(x[10])+","+str(x[11])+","+str(x[12])+","+str(x[13])+","+str(x[14])+","+str(x[15])+","+str(x[16])+","+str(x[17])+","+str(x[18])+","+str(x[19])+","+str(x[20])+","+str(x[21])+","+str(x[22])+","+str(x[23])+","+str(x[24])+","+str(x[25])+" ]"
  print "------------------------"

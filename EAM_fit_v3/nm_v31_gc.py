...
x0 = [x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25,x26,x27,x28,x29]
...
def f(x):
  ...
  text = text.replace('Fm2',str(x[18]).replace("[","").replace("]",""))
  text = text.replace('Fm3',str(x[19]).replace("[","").replace("]",""))
  text = text.replace('Fm4',str(x[20]).replace("[","").replace("]",""))
  text = text.replace('Fm5',str(x[21]).replace("[","").replace("]",""))
  text = text.replace('Fm6',str(x[22]).replace("[","").replace("]",""))
  text = text.replace('Fn0',str(x[23]).replace("[","").replace("]",""))
  text = text.replace('Fn1',str(x[24]).replace("[","").replace("]",""))
  text = text.replace('Fn2',str(x[25]).replace("[","").replace("]",""))
  text = text.replace('Fn3',str(x[26]).replace("[","").replace("]",""))
  text = text.replace('p1',str(x[27]).replace("[","").replace("]",""))
  text = text.replace('hc',str(x[28]).replace("[","").replace("]",""))
  text = text.replace('rhol',str(x[29]).replace("[","").replace("]",""))
  fi.close
  ...
  for t in temp:
    ...
    if count > 20000 or count % int(4000*2.718**(-count/4000)+1) == 1: 
  ...
  print "Evaluate: ", y
  #print "Parameters: ", x
  print "Parameters: x0 = "+"[ "+str(x[0])+","+str(x[1])+","+str(x[2])+","+str(x[3])+","+str(x[4])+","+str(x[5])+","+str(x[6])+","+str(x[7])+","+str(x[8])+","+str(x[9])+","+str(x[10])+","+str(x[11])+","+str(x[12])+","+str(x[13])+","+str(x[14])+","+str(x[15])+","+str(x[16])+","+str(x[17])+","+str(x[18])+","+str(x[19])+","+str(x[20])+","+str(x[21])+","+str(x[22])+","+str(x[23])+","+str(x[24])+","+str(x[25])+","+str(x[26])+","+str(x[27])+","+str(x[28])+","+str(x[29])+" ]"
  print "------------------------"

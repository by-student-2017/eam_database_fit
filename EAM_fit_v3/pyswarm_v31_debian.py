...
import sys
#----------------------------------------------------------------------
file_tmp = 'EAM_code_v3.tmp'
file_inp = 'EAM_code_v3'
...
print "weight     : ",weig
#----------------------------------------------------------------------
print "read parameters from EAM_code_v3.init"
nline = commands.getoutput("grep -n "+str(satom)+" EAM_code_v3.init | head -1 | sed -e \"s/:.*//g\"")
print "read line: "+nline
check_satom = commands.getoutput("awk '{if(NR=="+str(nline)+"+0){print $1}}' EAM_code_v3.init | head -1")
print "fit element: "+check_satom
# fitting parameters
x0  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+1){print $1}}' EAM_code_v3.init | head -1"))
x1  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+2){print $1}}' EAM_code_v3.init | head -1"))
x2  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+3){print $1}}' EAM_code_v3.init | head -1"))
x3  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+4){print $1}}' EAM_code_v3.init | head -1"))
x4  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+5){print $1}}' EAM_code_v3.init | head -1"))
x5  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+6){print $1}}' EAM_code_v3.init | head -1"))
x6  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+7){print $1}}' EAM_code_v3.init | head -1"))
x7  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+8){print $1}}' EAM_code_v3.init | head -1"))
x8  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+9){print $1}}' EAM_code_v3.init | head -1"))
x9  = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+10){print $1}}' EAM_code_v3.init | head -1"))
x10 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+11){print $1}}' EAM_code_v3.init | head -1"))
x11 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+12){print $1}}' EAM_code_v3.init | head -1"))
x12 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+13){print $1}}' EAM_code_v3.init | head -1"))
x13 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+14){print $1}}' EAM_code_v3.init | head -1"))
x14 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+15){print $1}}' EAM_code_v3.init | head -1"))
x15 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+16){print $1}}' EAM_code_v3.init | head -1"))
x16 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+17){print $1}}' EAM_code_v3.init | head -1"))
x17 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+18){print $1}}' EAM_code_v3.init | head -1"))
x18 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+19){print $1}}' EAM_code_v3.init | head -1"))
x19 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+20){print $1}}' EAM_code_v3.init | head -1"))
x20 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+21){print $1}}' EAM_code_v3.init | head -1"))
x21 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+22){print $1}}' EAM_code_v3.init | head -1"))
x22 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+23){print $1}}' EAM_code_v3.init | head -1"))
x23 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+24){print $1}}' EAM_code_v3.init | head -1"))
x24 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+25){print $1}}' EAM_code_v3.init | head -1"))
x25 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+26){print $1}}' EAM_code_v3.init | head -1"))
x26 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+27){print $1}}' EAM_code_v3.init | head -1"))
x27 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+30){print $1}}' EAM_code_v3.init | head -1"))
x28 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+31){print $1}}' EAM_code_v3.init | head -1"))
x29 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+32){print $1}}' EAM_code_v3.init | head -1"))
print "initial parameters: ",x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25,x26,x27,x28,x29
x = [x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25,x26,x27,x28,x29]
...
def example_fitness( individual ):
  ...
  text = text.replace('p0',str(individual[1]).replace("[","").replace("]",""))
  text = text.replace('rhoe',str(individual[2]).replace("[","").replace("]",""))
  text = text.replace('pk1',str(individual[3]).replace("[","").replace("]",""))
  text = text.replace('pk2',str(individual[4]).replace("[","").replace("]",""))
  text = text.replace('pk3',str(individual[5]).replace("[","").replace("]",""))
  text = text.replace('pk4',str(individual[6]).replace("[","").replace("]",""))
  text = text.replace('pk5',str(individual[7]).replace("[","").replace("]",""))
  text = text.replace('pk6',str(individual[8]).replace("[","").replace("]",""))
  text = text.replace('pk7',str(individual[9]).replace("[","").replace("]",""))
  text = text.replace('pk8',str(individual[10]).replace("[","").replace("]",""))
  text = text.replace('Fi0',str(individual[11]).replace("[","").replace("]",""))
  text = text.replace('Fi1',str(individual[12]).replace("[","").replace("]",""))
  text = text.replace('Fi2',str(individual[13]).replace("[","").replace("]",""))
  text = text.replace('Fi3',str(individual[14]).replace("[","").replace("]",""))
  text = text.replace('Fi4',str(individual[15]).replace("[","").replace("]",""))
  text = text.replace('Fi5',str(individual[16]).replace("[","").replace("]",""))
  text = text.replace('Fi6',str(individual[17]).replace("[","").replace("]",""))
  text = text.replace('Fm2',str(individual[18]).replace("[","").replace("]",""))
  text = text.replace('Fm3',str(individual[19]).replace("[","").replace("]",""))
  text = text.replace('Fm4',str(individual[20]).replace("[","").replace("]",""))
  text = text.replace('Fm5',str(individual[21]).replace("[","").replace("]",""))
  text = text.replace('Fm6',str(individual[22]).replace("[","").replace("]",""))
  text = text.replace('Fn0',str(individual[23]).replace("[","").replace("]",""))
  text = text.replace('Fn1',str(individual[24]).replace("[","").replace("]",""))
  text = text.replace('Fn2',str(individual[25]).replace("[","").replace("]",""))
  text = text.replace('Fn3',str(individual[26]).replace("[","").replace("]",""))
  text = text.replace('p1',str(individual[27]).replace("[","").replace("]",""))
  text = text.replace('hc',str(individual[28]).replace("[","").replace("]",""))
  text = text.replace('rhol',str(individual[29]).replace("[","").replace("]",""))
  fi.close
  ...
  print "Parameters: x0 = "+"[ "+str(individual[0])+","+str(individual[1])+","+str(individual[2])+","+str(individual[3])+","+str(individual[4])+","+str(individual[5])+","+str(individual[6])+","+str(individual[7])+","+str(individual[8])+","+str(individual[9])+","+str(individual[10])+","+str(individual[11])+","+str(individual[12])+","+str(individual[13])+","+str(individual[14])+","+str(individual[15])+","+str(individual[16])+","+str(individual[17])+","+str(individual[18])+","+str(individual[19])+","+str(individual[20])+","+str(individual[21])+","+str(individual[22])+","+str(individual[23])+","+str(individual[24])+","+str(individual[25])+","+str(individual[26])+","+str(individual[27])+","+str(individual[28])+","+str(individual[29])+" ]"
  print "------------------------"

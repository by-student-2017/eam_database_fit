...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      common /pass1/ re(16),p0(16),rhoe(16),
     *   pk1(16),pk2(16),pk3(16),pk4(16),
     *   pk5(16),pk6(16),pk7(16),pk8(16),
     *   p1(16),h(16),
     *   Fi0(16),Fi1(16),Fi2(16),Fi3(16),Fi4(16),
     *   Fi5(16),Fi6(16),Fi7(16),Fi8(16),Fi9(16),
     *   Fm2(16),Fm3(16),Fm4(16),Fm5(16),
     *   Fm6(16),Fm7(16),Fm8(16),Fm9(16),
     *   Fn0(16),Fn1(16),Fn2(16),Fn3(16),Fn4(16),
     *   Fn5(16),Fn6(16),Fn7(16),Fn8(16),Fn9(16),
...
10    continue
      ...
      open(unit=10,file='EAM_code_v32',form='FORMATTED',status='OLD')
...
c         read(10,*) rhos(ntypes)
         ...
         read(10,*) Fn8(ntypes)
         read(10,*) Fn9(ntypes)
c         read(10,*) fnn(ntypes)
c         read(10,*) Fn(ntypes)
         read(10,*) ielement(ntypes)
         read(10,*) amass(ntypes)
c         read(10,*) Fm4(ntypes)
         read(10,*) p1(ntypes)
         read(10,*) h(ntypes)
         read(10,*) rhol(ntypes)
         read(10,*) rhoh(ntypes)
c         blat(ntypes)=sqrt(2.0d0)*re(ntypes)
         blat(ntypes)=re(ntypes)/(sqrt(10.0d0)/2.0d0)
...
c      endif
     ...
     *       Fi7(it)*(rho/rhoin(it)-1.0d0)**7+
     *       Fi8(it)*(rho/rhoin(it)-1.0d0)**8+
     *       Fi9(it)*(rho/rhoin(it)-1.0d0)**9
     ...
     *       Fm7(it)*(rho/rhoin(it)-1.0d0)**7+
     *       Fm8(it)*(rho/rhoin(it)-1.0d0)**8+
     *       Fm9(it)*(rho/rhoin(it)-1.0d0)**9
      else
         emb=Fn0(it)+
     *       Fn1(it)*(rho/rhoout(it)-1.0d0)+
     *       Fn2(it)*(rho/rhoout(it)-1.0d0)**2+
     *       Fn3(it)*(rho/rhoout(it)-1.0d0)**3+
     *       Fn4(it)*(rho/rhoout(it)-1.0d0)**4+
     *       Fn5(it)*(rho/rhoout(it)-1.0d0)**5+
     *       Fn6(it)*(rho/rhoout(it)-1.0d0)**6+
     *       Fn7(it)*(rho/rhoout(it)-1.0d0)**7+
     *       Fn8(it)*(rho/rhoout(it)-1.0d0)**8+
     *       Fn9(it)*(rho/rhoout(it)-1.0d0)**9

...
x = [x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25,x26,x27,x28,x29,x30,x31,x32,x33,x34,x35,x36,x37,x38,x39,x40,x41]
print "initial parameters: ",x

count = 0
#----------------------------------------------------------------------
n_gene = 42 # number of parameters
...
def example_fitness( individual ):
  ...
  text = text.replace('Fi7',str(individual[18]).replace("[","").replace("]",""))
  text = text.replace('Fi8',str(individual[19]).replace("[","").replace("]",""))
  text = text.replace('Fi9',str(individual[20]).replace("[","").replace("]",""))
  text = text.replace('Fm2',str(individual[21]).replace("[","").replace("]",""))
  text = text.replace('Fm3',str(individual[22]).replace("[","").replace("]",""))
  text = text.replace('Fm4',str(individual[23]).replace("[","").replace("]",""))
  text = text.replace('Fm5',str(individual[24]).replace("[","").replace("]",""))
  text = text.replace('Fm6',str(individual[25]).replace("[","").replace("]",""))
  text = text.replace('Fm7',str(individual[26]).replace("[","").replace("]",""))
  text = text.replace('Fm8',str(individual[27]).replace("[","").replace("]",""))
  text = text.replace('Fm9',str(individual[28]).replace("[","").replace("]",""))
  text = text.replace('Fn0',str(individual[29]).replace("[","").replace("]",""))
  text = text.replace('Fn1',str(individual[30]).replace("[","").replace("]",""))
  text = text.replace('Fn2',str(individual[31]).replace("[","").replace("]",""))
  text = text.replace('Fn3',str(individual[32]).replace("[","").replace("]",""))
  text = text.replace('Fn4',str(individual[33]).replace("[","").replace("]",""))
  text = text.replace('Fn5',str(individual[34]).replace("[","").replace("]",""))
  text = text.replace('Fn6',str(individual[35]).replace("[","").replace("]",""))
  text = text.replace('Fn7',str(individual[36]).replace("[","").replace("]",""))
  text = text.replace('Fn8',str(individual[37]).replace("[","").replace("]",""))
  text = text.replace('Fn9',str(individual[38]).replace("[","").replace("]",""))
  text = text.replace('p1',str(individual[39]).replace("[","").replace("]",""))
  text = text.replace('hc',str(individual[40]).replace("[","").replace("]",""))
  text = text.replace('rhol',str(individual[41]).replace("[","").replace("]",""))
  fi.close
  ...
  print "Parameters: x0 = "+"[ "+str(individual[0])+","+str(individual[1])+","+str(individual[2])+","+str(individual[3])+","+str(individual[4])+","+str(individual[5])+","+str(individual[6])+","+str(individual[7])+","+str(individual[8])+","+str(individual[9])+","+str(individual[10])+","+str(individual[11])+","+str(individual[12])+","+str(individual[13])+","+str(individual[14])+","+str(individual[15])+","+str(individual[16])+","+str(individual[17])+","+str(individual[18])+","+str(individual[19])+","+str(individual[20])+","+str(individual[21])+","+str(individual[22])+","+str(individual[23])+","+str(individual[24])+","+str(individual[25])+","+str(individual[26])+","+str(individual[27])+","+str(individual[28])+","+str(individual[29])+","+str(individual[30])+","+str(individual[31])+","+str(individual[32])+","+str(individual[33])+","+str(individual[34])+","+str(individual[35])+","+str(individual[36])+","+str(individual[37])+","+str(individual[38])+","+str(individual[39])+","+str(individual[40])+","+str(individual[41])+" ]"
  print "------------------------"
